    ...
    <div class="login login-with-news-feed">
        ...
        <div class="news-feed">
            ...
            <div class="news-caption">
                <h4 class="caption-title"><b>Setup</b></h4>
                <p>
                    Setup
                </p>
            </div>
        ...
        <div class="right-content">
            ...
            <div class="login-header">
                <div class="brand">
                    <span class="logo"></span> <b>Setup</b>
            ...
            <div class="login-content">
                <form action="<?= site_url('setup/step1/do'); ?>" method="POST" class="margin-bottom-0">
                    <div class="form-group m-b-15">
                        <input type="text" class="form-control form-control-lg" id="setting_webname"
                               name="setting_webname"
                               placeholder="Web Name" required/>
                    </div>
                    <div class="form-group m-b-15">
                        <input type="text" class="form-control form-control-lg" id="setting_organization"
